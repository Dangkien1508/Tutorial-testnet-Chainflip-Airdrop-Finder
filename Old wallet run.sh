...
read -p "Enter Secret phrase: " Secret_phrase
echo -n "Secret_phrase" >> sign_key.txt
sleep 2

read -p "Enter Network ID: "  Network_ID
echo -n "Network_ID" >> sign_key.txt
sleep 2

read -p "Enter Secret seed: "  Secret_seed
echo -n "Secret_seed" >> sign_key.txt
sleep 2

read -p "Enter Public key (hex): "  Public_key
echo -n "Public_key (hex)" >> sign_key.txt
sleep 2

read -p "Enter account ID: "  Account_ID
echo -n "Account_ID" >> sign_key.txt
sleep 2

read -p "Enter Public key (SS58): "  Public_key
echo -n "Public_key_(SS58)" >> sign_key.txt
sleep 2

read -p "Enter SS58 Address: "  SS58_Address
echo -n "SS58_Address" >> sign_key.txt
sleep 2
